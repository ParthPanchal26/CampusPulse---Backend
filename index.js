...
app.use(
  cors({
      origin: [process.env.FRONTEND_URL, 'http://localhost:5173', "http://localhost:5174", "https://parthpanchal26.github.io/campuspulse/"],
...
// Database connection
mongoose.connect(process.env.MONGODB_URI, {dbName: 'campuspulse'})
